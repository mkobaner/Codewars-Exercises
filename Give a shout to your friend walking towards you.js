/*Give a shout to your friend walking towards you https://www.codewars.com/kata/63a2928176157931b3945090/train/javascript
...
function madShout(sidewalk){
  yPos= sidewalk.indexOf('Y');
  fPos=sidewalk.indexOf('F');

    if(fPos-yPos>=2){ return 'Oi F!'} else if(fPos-yPos>=8) {
        return 'Oiiiii F!'} else if(fPos-yPos<=19) {
            return 'Oiiiiiiiiii F!'}
