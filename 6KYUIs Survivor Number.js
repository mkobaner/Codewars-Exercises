/*Simple Fun #143: Is Survivor Number? Changu and Mangu are great buddies. Once they found an infinite paper which had 1,2,3,4,5,6,7,8,......... till infinity, written on it.
...
let survivor=n=> {
    ...
    let pos = n;
    while (round <= pos) {
      if (pos % round === 0) return false;
      pos = pos - Math.floor(pos/round);
      round++;
    }
    return true;
  }
